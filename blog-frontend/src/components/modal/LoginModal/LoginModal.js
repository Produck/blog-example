...
const LoginModal = ({
  ...
  <ModalWrapper visible={visible}>
    <div className={cx('form')}>
      ...
      <input autoFocus type="password" placeholder="Ente The Password" value={password} onChange={onChange} onKeyPress={onKeyPress} />
      { error && <div className={cx('error')}>Failed to login</div>}
